...
public class SpellBookInfoFactory {
    ...
    private final static List<SpellInfo> spellList = new ArrayList<>();
    {
        ...
        //3-4
        spellList.add(SpellInfo.builder().aTarget(SpellInfo.Target.ANY).aCost(200).aDescription("All undead creature troops receive ((Power x 10) + 10) damage.").aDuration(0).aManaCost(15).aName(DESTROY_UNDEAD).aLevel(3).aType(SpellInfo.Type.AIR).build());
