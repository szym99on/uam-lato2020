...
public class SpellBookInfoFactory {
    ...
    private final static List<SpellInfo> spellList = new ArrayList<>();
    {
        ...
        spellList.add(SpellInfo.builder().aCost(1).aDescription("Allows you to summon elementals. Once cast, no other elemental types may be summoned.").aDuration("Combat").aManaCost(25).aName(AIR_ELEMENTAL).aLevel(5).aType(SpellInfo.Type.AIR).build());
        spellList.add(SpellInfo.builder().aCost(1).aDescription("Allows you to summon elementals. Once cast, no other elemental types may be summoned.").aDuration("Combat").aManaCost(25).aName(FIRE_ELEMENTAL).aLevel(5).aType(SpellInfo.Type.FIRE).build());
        spellList.add(SpellInfo.builder().aCost(1).aDescription("Allows you to summon elementals. Once cast, no other elemental types may be summoned.").aDuration("Combat").aManaCost(25).aName(EARTH_ELEMENTAL).aLevel(5).aType(SpellInfo.Type.EARTH).build());
        spellList.add(SpellInfo.builder().aCost(1).aDescription("Allows you to summon elementals. Once cast, no other elemental types may be summoned.").aDuration("Combat").aManaCost(25).aName(WATER_ELEMENTAL).aLevel(5).aType(SpellInfo.Type.WATER).build());
    }
