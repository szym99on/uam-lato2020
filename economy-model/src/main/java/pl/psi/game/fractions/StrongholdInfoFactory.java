...
public class StrongholdInfoFactory extends FractionsInfoAbstractFactory {
    ...
    private final static List<CreatureInfo> creatureList = new ArrayList<>();
    {
        ...
        creatureList.add(CreatureInfo.builder().aMaxHp(60).aAttack(Range.closed(6, 12)).aName("Ogre Magi").aArmor(7).aMoveRange(5).build());
        creatureList.add(CreatureInfo.builder().aMaxHp(60).aAttack(Range.closed(11, 15)).aName("Thunderbird").aArmor(11).aMoveRange(11).build());
        creatureList.add(CreatureInfo.builder().aMaxHp(70).aAttack(Range.closed(16, 20)).aName("Cyclops King").aArmor(13).aMoveRange(8).build());
        creatureList.add(CreatureInfo.builder().aMaxHp(300).aAttack(Range.closed(30, 50)).aName("Ancient Behemoth").aArmor(19).aMoveRange(9).build());
    }
}
